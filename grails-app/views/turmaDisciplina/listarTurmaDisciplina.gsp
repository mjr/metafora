...
<html lang="pt-br">
<head>
<title>Curso . Módulo Acadêmico</title>
...
<body>
	...
	<div id="side">
		<ul class="nav nav-pills nav-stacked">
			...
			<li class="active"><g:link controller="TurmaDisciplina"
					action="listar">Curso</g:link></li>
	...
	<div id="content-academico">
		<h4 style="margin-bottom: -35px;">Cursos Cadastrados</h4>
