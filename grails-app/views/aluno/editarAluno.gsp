...
<body>
	...
	<div id="content">
		...
		<h4 style="margin-bottom: 5px;">Editar Aluno</h4>
		...
		<div style="margin-left: 120px">
			<g:form controller="Aluno" action="atualizar"
				...
				<fieldset>
					...
					<div class="form-group">
						<label for="inputnumeroDeInscricao3" class="col-sm-2 control-label">Número de Inscrição</label>
						<div class="col-sm-10">
							<g:textField class="form-control" 
								name="numeroDeInscricao" style="width: 300px"
								value="${it.numeroDeInscricao}" />
						</div>
					</div>
					<br>
				</fieldset>
