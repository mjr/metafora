...
<html lang="pt-br">
<head>
<title>Editar Professor . Modulo Pessoal</title>
...
<body>
	...
	<div id="content">
		...
		<h4 style="margin-bottom: 5px;">Editar Professor</h4>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<g:textField class="form-control" required="" name="cargaHoraria"
								style="width: 300px" value="${funcionario.cargaHoraria}" />
						</div>
					</div>
					<br>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<g:textField class="form-control" name="identificacao"
								style="width: 300px" value="${it.identificacao}" />
						</div>
					</div>
					<br>
				</fieldset>
				<div style="margin-left: 220px">
					...
					<ul style="display: inline-block; margin-left: -30px">
						<li class="btn btn-default btn"><a
							href="/DBMetafora/professor/listar/">Cancelar</a></li>
					</ul>
				</div>
			</g:form>
		</div>
