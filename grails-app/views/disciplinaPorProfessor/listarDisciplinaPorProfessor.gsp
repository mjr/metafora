...
<html lang="pt-br">
<head>
<title>Disciplina por Professor . Módulo Acadêmico</title>
...
<body>
	...
	<div id="side">
		<ul class="nav nav-pills nav-stacked">
			...
			<li class="active"><g:link
					controller="DisciplinaLecionadaPorProfessor" action="listar">Disciplina por Professor</g:link></li>
	...
	<div id="content-academico">
		<h4 style="margin-bottom: -35px;">Disciplinas por Professores Cadastradas</h4>
